...
attributes = {"startup" : "**Startup:** {0} frames", "totalframes" : "**Total Frames:** {0} frames", "landinglag" : "**Landing Lag:** {0} frames", "notes" : "**Notes:** {0}", "basedamage" : "**Base Damage:** {0}", "shieldlag" : "**Shield Lag:** {0} frames", "shieldstun" : "**Shield Stun:** {0} frames", "whichhitbox" : "**Which Hitbox:** {0}", "advantage" : "**On Shield:** {0} frames on shield", "activeframes" : "**Active Frames:** {0}"}
					...
					for z in x.parent.find_all("a"): # Find the hitbox images
						...
						for a in ["startup", "totalframes", "landinglag", "notes", "basedamage", "shieldlag", "shieldstun", "whichhitbox", "advantage", "activeframes"]: # Find all these attributes of a move
							if not "--" in x.parent.find("div", class_=a).text.strip(): # If they don't exist, they are set as '--'
								desc = desc + "\n" + attributes[a].format(x.parent.find("div", class_=a).text.strip()) # Append this to the embed description, 'prettified' with the attributes dict
